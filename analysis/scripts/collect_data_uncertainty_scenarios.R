...
## Gather data-------------
##===================================##
parameters_df = read_csv(file.path(output_dir_sims,'uncertainty_params_file.csv'))
combined_output_file = file.path(output_dir, "output_uncertainty_analysis_scenarios.csv")
...
for(ii in sims_list){
    ...
    out_file = file.path(output_dir_sims,sprintf("output_uncertainty_analysis_sims_%d.csv",ii))
