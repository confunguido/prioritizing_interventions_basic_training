...
write.csv(inf.testDay, '../output/output_immunity_scenarios.csv', row.names = F)
write.csv(inf.time, '../output/output_immunity_time_scenarios.csv', row.names = F)
