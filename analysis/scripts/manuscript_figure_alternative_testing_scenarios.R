...
inf.testDay = read.csv('../output/output_alternative_testing_scenarios.csv', stringsAsFactors = F)
inf.time = read.csv('../output/output_alternative_testing_time_scenarios.csv', stringsAsFactors = F)
...
##==================================================#
outbreak_min = 100
jpeg('../figures/manuscript_figure_alternative_testing_scenarios.jpeg',  width=6.5,height=4, units="in", res = 300)
...
##==================================================#
outbreak_min = 100
jpeg('../figures/manuscript_figure_alternative_testing_scenarios_time.jpeg',  width=10,height=6, units="in", res = 300)
...
##==================================================#
outbreak_min = 100
jpeg('../figures/manuscript_figure_alternative_testing_scenarios_curvedplots.jpeg',  width=10,height=6, units="in", res = 300)
layout(matrix(1:(length(importations_list) * length(test_scenarios)),nrow = length(importations_list), byrow = T))
par(mar = c(0,0,0,0), oma = c(5,5,3,3))
for(pp_import in 1:length(importations_list)){
    tmp_out = inf.time[inf.time$importation == importations_list[pp_import],]    
