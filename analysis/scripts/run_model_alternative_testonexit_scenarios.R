...
write.csv(inf.testDay, '../output/output_alternative_testonexit_scenarios.csv', row.names = F)
write.csv(inf.time, '../output/output_alternative_testonexit_time_scenarios.csv', row.names = F)
